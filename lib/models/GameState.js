...
module.exports = class GameState {
    ...
    insert({ id, userName, position, dir, avatar, characterType, socketId, currentRoom }) {
        this.userArray.push({ id, userName, position, dir, avatar, characterType, socketId, currentRoom });
