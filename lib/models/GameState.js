...
module.exports = class GameState {
    ...
    insert({ id, userName, position, dir, avatar, characterType, socketId, currentRoom, idle, dimension }) {
    ...
    update({ id, userName, position, dir, avatar, characterType, socketId, idle, dimension }) {
        ...
        if (this.ballArray) {
            this.ballArray.forEach(ball => ball.userCollisionCheck(this.userArray, this.wallArray));
        }
        return {
